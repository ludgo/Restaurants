...
restaurant1 = Restaurant(name="Urban Burger", description="The freshest burgers in the world",
...
restaurant2 = Restaurant(name="Super Stir Fry", description="",
...
restaurant1 = Restaurant(name="Panda Garden", description="",
...
restaurant1 = Restaurant(name="Tony\'s Bistro ", description="",
...
# Menu for Andala's
restaurant1 = Restaurant(name="Andala\'s", description="",
...
restaurant1 = Restaurant(name="Auntie Ann\'s Diner' ", description="",
...
restaurant1 = Restaurant(name="Cocina Y Amor ", description="",
                     city="Dallas", state="Texas")
...
restaurant1 = Restaurant(name="State Bird Provisions", description="",
